...
QT_MOC_LITERAL(1, 6, 9), // "drawSnake"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 15), // "QVector<QPoint>"
QT_MOC_LITERAL(4, 33, 4), // "prev"
QT_MOC_LITERAL(5, 38, 4), // "next"
QT_MOC_LITERAL(6, 43, 4) // "move"

    },
    "Snake\0drawSnake\0\0QVector<QPoint>\0prev\0"
    "next\0move"
};
...
void Snake::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->drawSnake((*reinterpret_cast< QVector<QPoint>(*)>(_a[1])),(*reinterpret_cast< QVector<QPoint>(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Snake::*)(QVector<QPoint> , QVector<QPoint> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Snake::drawSnake)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Snake::drawSnake(QVector<QPoint> _t1, QVector<QPoint> _t2)
{
